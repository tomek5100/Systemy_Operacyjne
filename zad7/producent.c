/* 
   Program zawierajacy "producenta". Otwiera dwa semafory oraz obiekt P.D
   nastepnie realizuje kopiowanie tekstu z pliku in.txt do P.D. Ponadto
   wpisuje znak konca pliku w celu poinformowania konsumenta o zakonczeniu 
   dzialania. 
   --------------------------------------------------------------------
...
//        printf("\t\t[PRODUCENT]wpisalem EOF do pamieci dzielonej\n");
        podnies(semaforB);
