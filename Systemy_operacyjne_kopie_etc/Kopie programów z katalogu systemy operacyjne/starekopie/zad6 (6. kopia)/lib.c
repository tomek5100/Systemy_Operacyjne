...
semid sem; //zmienna trzymajaca adres semafora, semid to TYP zmiennej
semid tworzenie(const char *name, int value){ //int value moge usunac
    if((sem = sem_open(name, O_CREAT | O_EXCL, 0644, value)) == SEM_FAILED){ //tworze semafor nazwany o wartosci 1
